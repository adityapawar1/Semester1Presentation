...
class SA_RectPrism(ThreeDScene):
    def construct(self):
...
class SA_Deconstruction(ThreeDScene):
    def construct(self):
...
class SA_Accumulation(ThreeDScene):
    def construct(self):
...
class SA_Example_ArcLength(Scene):
    def construct(self):
...
class SA_Example_Calculation(ThreeDScene):
    def construct(self):
